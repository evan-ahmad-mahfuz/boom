...
\033[1;92m☞ WhatsApp   : nambar demou na
...
def mb():
	...
	if bm =='':
	    ...
	    time.sleep(2)
	    os.system('cd $HOME/B4_BALOCH && python2 Boom.py')
	elif bm =='3':
...
def pb():
	...
	print(S+50*'-')
	print
  int(S+'Process has been completed CP ID Open After Days ')
	print(Y+'Total '+G+'OK'+S+'/'+P+'CP'+S+' = '+G+str(len(oks))+S+'/'+R+str(len(cps)))
	print(S+'blackevan')     
	print
	raw_input(R + 'Back')
	os.system('python2 Boom.py')
